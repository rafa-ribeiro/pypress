...
class DuckDuckGoResultPage:
    ...
    def link_first_result(self):
        first_result = self.browser.find_element(*self.FIRST_RESULT)
        return first_result.get_attribute('data-domain')
