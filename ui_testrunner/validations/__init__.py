...
scenarios = [
    {
        ...
        'prepare': {
            'on_page': 'https://www.vivadecora.com.br/decoracao',
        },
        'action': {
    ...
    },
    {
        ...
        'prepare': {
            'on_page': 'https://www.vivadecora.com.br/produtos/sofas',
        },
        'action': {
            'wait_for': 3,
    ...
    },
    {
        ...
        'prepare': {
            'on_page': 'https://www.vivadecora.com.br/produtos/sofas/pagina/2',
        },
        'action': {
            'wait_for': 3,
            'collect_elements': 'CLASS=product-box',
